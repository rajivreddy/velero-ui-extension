...
export default class DataUpload extends SteveModel {
  ...
  get snapshotType() {
    return this.spec?.snapshotType || '-';
  }

  get sourceNamespace() {
    return this.spec?.sourceNamespace || '-';
  }

  get sourcePVC() {
    return this.spec?.sourcePVC || '-';
  }

  get csiSnapshot() {
    return this.spec?.csiSnapshot || null;
  }
